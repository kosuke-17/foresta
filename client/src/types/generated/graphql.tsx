...
export type GetUserByIdQuery = { __typename?: 'Query', user: { __typename?: 'ResponseUser', node: { __typename?: 'User', name: string, jobType: string, spreadSheetID: string, githubURL: string, portfolio: Array<{ __typename?: 'Portfolio', title: string, description: string, img: string, portfolioURL: string } | null>, userUrls: { __typename?: 'UserUrls', user_urls: Array<{ __typename?: 'URL', urlName: string, url: string }> } } } };
...
export type UserLoginMutation = { __typename?: 'Mutation', userLogin: { __typename?: 'ResponseUser', status: string, node: { __typename?: 'User', id: string, name: string, jobType: string, email: string, password: string, githubURL: string } } };

export type GetAllUserQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllUserQuery = { __typename?: 'Query', getAllUser: Array<{ __typename?: 'User', name: string, jobType: string, email: string, password: string, githubURL: string }> };
...
export type GetAllStudyStackQuery = { __typename?: 'Query', getAllStudyStack: { __typename?: 'ResponseStudyStackArr', status: string, msg: string, node: Array<{ __typename?: 'StudyStack', id: string, content: string, timeStack: number, createdAt: string, skillTagId: string, userId: string }> } };
...
export type GetStudyStackByIdQuery = { __typename?: 'Query', getStudyStackById: { __typename?: 'ResponseStudyStack', status: string, node: { __typename?: 'StudyStack', id: string, content: string, timeStack: number, createdAt: string, skillTagId: string, userId: string } } };
...
export type AddStudyStackMutation = { __typename?: 'Mutation', addStudyStack: { __typename?: 'ResponseStudyStack', status: string, node: { __typename?: 'StudyStack', id: string, content: string, timeStack: number, createdAt: string, skillTagId: string, userId: string } } };
...
export type UpdateStudyStackMutation = { __typename?: 'Mutation', updateStudyStack: { __typename?: 'ResponseStudyStack', status: string, node: { __typename?: 'StudyStack', id: string, content: string, timeStack: number, createdAt: string, skillTagId: string, userId: string } } };
...
export type GetAllTodoByUserQuery = { __typename?: 'Query', todos: { __typename?: 'ResponseTodoArr', node: Array<{ __typename?: 'Todo', id: string, title: string, startedAt: string, finishedAt?: string | null, isStatus: boolean }> } };
...
export type GetTodoByIdQuery = { __typename?: 'Query', todo: { __typename?: 'ResponseTodo', node: { __typename?: 'Todo', id: string, title: string, description?: string | null, startedAt: string, finishedAt?: string | null, isStatus: boolean } } };

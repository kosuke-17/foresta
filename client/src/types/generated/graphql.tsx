...
export type GetAllUserQuery = { __typename?: 'Query', getAllUser?: Array<{ __typename?: 'User', id: string, name: string, jobType: string, email: string, password: string, githubURL: string }> | null };

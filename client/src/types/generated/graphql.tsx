...
export type GetUserByIdQuery = { __typename?: 'Query', user: { __typename?: 'User', name: string, jobType: string, email: string, password: string, githubURL: string, userUrls?: { __typename?: 'UserUrls', user_urls: Array<{ __typename?: 'URL', url: string, urlName: string }> } | null, portfolio?: Array<{ __typename?: 'Portfolio', title: string, description: string, img: string, portfolioURL: string } | null> | null } };
...
export type UserLoginMutation = { __typename?: 'Mutation', userLogin: { __typename?: 'ResponseUser', status: string, node?: { __typename?: 'User', id: string, name: string, jobType: string, email: string, password: string, githubURL: string } | null } };
...
export type GetAllStudyStackQuery = { __typename?: 'Query', getAllStudyStack: Array<{ __typename?: 'StudyStack', id: string, timeStack: number, content: string, createdAt: string, skillTagId: string, userId: string }> };
...
export type GetStudyStackByIdQuery = { __typename?: 'Query', getStudyStackById: { __typename?: 'StudyStack', id: string, content: string, timeStack: number, createdAt: string, skillTagId: string, userId: string } };
...
export type GetAllTodoByUserQuery = { __typename?: 'Query', todos: Array<{ __typename?: 'Todo', id: string, title: string, startedAt: string, finishedAt?: string | null, isStatus: boolean }> };
...
export type GetTodoByIdQuery = { __typename?: 'Query', todo: { __typename?: 'Todo', id: string, title: string, description?: string | null, startedAt: string, finishedAt?: string | null, isStatus: boolean } };
